...
#include "AventuraUSFX022026L1/Enemigo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	AVENTURAUSFX022026L1_API UClass* Z_Construct_UClass_AEnemigo_NoRegister();
	AVENTURAUSFX022026L1_API UClass* Z_Construct_UClass_AEnemigo();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AEnemigo_OnOverlapBegin_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// ===== COLISI?N CON PROYECTIL =====\n" },
		{ "ModuleRelativePath", "Enemigo.h" },
		{ "ToolTip", "===== COLISI?N CON PROYECTIL =====" },
	};
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bVivo_MetaData[];
#endif
		static void NewProp_bVivo_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bVivo;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEnemigo_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AEnemigo_OnOverlapBegin, "OnOverlapBegin" }, // 3486661117
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AEnemigo_Statics::NewProp_Vida = { "Vida", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEnemigo, Vida), METADATA_PARAMS(Z_Construct_UClass_AEnemigo_Statics::NewProp_Vida_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemigo_Statics::NewProp_Vida_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemigo_Statics::NewProp_Malla_MetaData[] = {
		{ "Category", "Enemigo" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEnemigo_Statics::NewProp_Malla = { "Malla", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEnemigo, Malla), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEnemigo_Statics::NewProp_Malla_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemigo_Statics::NewProp_Malla_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemigo_Statics::NewProp_bVivo_MetaData[] = {
		{ "Category", "Enemigo" },
		{ "Comment", "// ===== ESTADO =====\n" },
		{ "ModuleRelativePath", "Enemigo.h" },
		{ "ToolTip", "===== ESTADO =====" },
...
#endif
	void Z_Construct_UClass_AEnemigo_Statics::NewProp_bVivo_SetBit(void* Obj)
	{
		((AEnemigo*)Obj)->bVivo = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AEnemigo_Statics::NewProp_bVivo = { "bVivo", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AEnemigo), &Z_Construct_UClass_AEnemigo_Statics::NewProp_bVivo_SetBit, METADATA_PARAMS(Z_Construct_UClass_AEnemigo_Statics::NewProp_bVivo_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemigo_Statics::NewProp_bVivo_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEnemigo_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemigo_Statics::NewProp_Malla,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemigo_Statics::NewProp_Velocidad,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemigo_Statics::NewProp_bVivo,
	};
	...
	IMPLEMENT_CLASS(AEnemigo, 2756619070);
	template<> AVENTURAUSFX022026L1_API UClass* StaticClass<AEnemigo>()
	{
		return AEnemigo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEnemigo(Z_Construct_UClass_AEnemigo, &AEnemigo::StaticClass, TEXT("/Script/AventuraUSFX022026L1"), TEXT("AEnemigo"), false, nullptr, nullptr, nullptr);
